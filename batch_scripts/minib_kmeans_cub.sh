...
#SBATCH --job-name=minib_cub
#SBATCH --output=outfiles/minib_cub.out.%j
#SBATCH --error=outfiles/minib_cub.out.%j
...
for backbone in ${BACKBONES[@]}; do
    srun bash -c "python minib_kmeans.py --backbone $BACKBONES_DIR/$backbone --dataset $DATASET --num-clusters 200;"
done
