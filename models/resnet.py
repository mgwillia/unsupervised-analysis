...
def resnet50x2(**kwargs):
    backbone = ResNet(Bottleneck, [3, 4, 6, 3], width_mult=2)
    return {'backbone': backbone, 'dim': 2048 * 2}

def resnet50x4(**kwargs):
    backbone = ResNet(Bottleneck, [3, 4, 6, 3], width_mult=4)
    return {'backbone': backbone, 'dim': 2048 * 4}